...
`;function xi({name:e,state:t,onChange:n}){return V(G1,{children:[S("label",{htmlFor:"name",children:e}),S("input",{type:"text",id:e,onChange:n,value:t}),S("span",{id:e+"ToAddWarning",className:"Warning"})]})}const Y1=xe.div`
    display: flex;
    flex-direction: column;
    position: relative;
...
`,ip=C.createContext({});function K1({children:e}){const[t,n]=C.useState(["Hours","Minutes","Minutes","Seconds","Miliseconds"]),[r,i]=C.useState(!1),[o,l]=C.useState([]);return S(ip.Provider,{value:{enabledFields:t,setEnabledFields:n,format:r,setFormat:i,events:o,setEvents:l},children:e})}function rr(){return C.useContext(ip)}function Si({name:e,state:t,onChange:n}){const{enabledFields:r}=rr();return V(Y1,{children:[S("label",{htmlFor:"name",children:e}),S("input",{type:"text",id:e,value:r.includes(e+"s")?t:"--",disabled:!r.includes(e+"s"),onChange:n}),S("span",{id:"Initial"+e+"Warning",className:"Warning"})]})}const X1=xe.div`
    display: flex;
    flex-direction: column;
...
`;function ki({name:e,state:t}){return V(X1,{children:[S("label",{htmlFor:"Resulting"+e,children:e}),S("span",{id:"Resulting"+e,children:t})]})}const Z1=xe.div`
    display: flex;
    position: relative;
...
`;function ug(e){return kn({tag:"svg",attr:{version:"1.2",baseProfile:"tiny",viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M12 3c-4.963 0-9 4.038-9 9s4.037 9 9 9 9-4.038 9-9-4.037-9-9-9zm0 16c-3.859 0-7-3.14-7-7s3.141-7 7-7 7 3.14 7 7-3.141 7-7 7zM12.707 12l2.646-2.646c.194-.194.194-.512 0-.707-.195-.194-.513-.194-.707 0l-2.646 2.646-2.646-2.647c-.195-.194-.513-.194-.707 0-.195.195-.195.513 0 .707l2.646 2.647-2.646 2.646c-.195.195-.195.513 0 .707.097.098.225.147.353.147s.256-.049.354-.146l2.646-2.647 2.646 2.646c.098.098.226.147.354.147s.256-.049.354-.146c.194-.194.194-.512 0-.707l-2.647-2.647z"}}]})(e)}function sg({name:e,hours:t,minutes:n,seconds:r,id:i}){const{setEvents:o}=rr();function l(){o(a=>a.filter(u=>u.id!=i))}return V(ag,{children:[S("button",{className:"Delete",onClick:()=>l(),children:S(ug,{})}),S("span",{className:"Name",children:e}),V("div",{className:"DurationWrapper",children:[S("span",{children:"Duration:"}),V("div",{className:"FieldsWrapper",children:[V(Rl,{children:[S("label",{htmlFor:"hours",children:"Hours"}),S("input",{type:"text",id:"hours",disabled:!0,value:t})]}),V(Rl,{children:[S("label",{htmlFor:"hours",children:"Minutes"}),S("input",{type:"text",id:"hours",disabled:!0,value:n})]}),V(Rl,{children:[S("label",{htmlFor:"hours",children:"Seconds"}),S("input",{type:"text",id:"hours",disabled:!0,value:r})]})]})]})]})}const cg=xe.li`
    padding: 1rem;
...
`;function dg(e){return kn({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M363 277h-86v86h-42v-86h-86v-42h86v-86h42v86h86v42z"}},{tag:"path",attr:{d:"M256 90c44.3 0 86 17.3 117.4 48.6C404.7 170 422 211.7 422 256s-17.3 86-48.6 117.4C342 404.7 300.3 422 256 422c-44.3 0-86-17.3-117.4-48.6C107.3 342 90 300.3 90 256c0-44.3 17.3-86 48.6-117.4C170 107.3 211.7 90 256 90m0-42C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48z"}}]})(e)}function fg({}){const{setEvents:e}=rr(),[t,n]=C.useState(""),[r,i]=C.useState(""),[o,l]=C.useState(""),[a,u]=C.useState("");function s(d,g){if(!(d>=9007199254740991))switch(g){case"hour":d!=""&!isNaN(parseInt(d))&&i(parseInt(d)),d==""&&i(0);break;case"minute":d!=""&!isNaN(parseInt(d))&&l(parseInt(d)),d==""&&l(0);break;case"second":d!=""&!isNaN(parseInt(d))&&u(parseInt(d)),d==""&&u(0);break}}function m(){const d={name:t,hour:r,minute:o,second:a,id:Date.now()};d.hour==""&&(d.hour=0),d.minute==""&&(d.minute=0),d.second==""&&(d.second=0),e(g=>[d,...g]),n(""),i(""),l(""),u(""),console.log(d)}return V(cg,{children:[S("button",{className:"Add",onClick:()=>m(),children:S(dg,{})}),V("div",{className:"Name",children:[S("label",{htmlFor:"Name",children:"New event name"}),S("input",{type:"text",id:"Name",value:t,onChange:d=>n(d.target.value)})]}),V("div",{className:"DurationWrapper",children:[S("span",{children:"Duration:"}),V("div",{className:"FieldsWrapper",children:[V(Il,{children:[S("label",{htmlFor:"hours",children:"Hours"}),S("input",{type:"text",id:"hours",value:r,onChange:d=>s(d.target.value,"hour")})]}),V(Il,{children:[S("label",{htmlFor:"hours",children:"Minutes"}),S("input",{type:"text",id:"hours",value:o,onChange:d=>s(d.target.value,"minute")})]}),V(Il,{children:[S("label",{htmlFor:"hours",children:"Seconds"}),S("input",{type:"text",id:"hours",value:a,onChange:d=>s(d.target.value,"second")})]})]})]})]})}function pg(){const{events:e}=rr(),[t,n]=C.useState(""),[r,i]=C.useState(""),[o,l]=C.useState("");return C.useEffect(()=>{function a(){let u=0,s=0,m=0;if(e.map(d=>u+=parseInt(d.hour)),e.map(d=>s+=parseInt(d.minute)),e.map(d=>m+=parseInt(d.second)),m>59){const d=Math.floor(m/60);m=m%60,s+=d}if(s>59){const d=Math.floor(s/60);s=s%60,console.log(u),u+=d,console.log(d,s)}if(u>=9007199254740991){alert("Max result value reached, exclude one or more events to recalculate");return}n(u),i(s),l(m),isNaN(u)&&n(0),isNaN(s)&&i(0),isNaN(m)&&l(0)}a()},[e]),V(ig,{children:[V("header",{children:[" ",S(Yu,{})," "]}),V(og,{children:[S("span",{children:"Events"}),S(fg,{}),e.map((a,u)=>S(sg,{name:a.name,hours:a.hour,minutes:a.minute,seconds:a.second,id:a.id},u))]}),V(lg,{children:[S("h2",{children:"Result"}),V("div",{id:"resultsWrapper",children:[V("div",{className:"resultWrapper",children:[S("label",{htmlFor:"hours",children:"Hours"}),V("span",{id:"hours",children:[" ",t," "]})]}),V("div",{className:"resultWrapper",children:[S("label",{htmlFor:"minutes",children:"Minutes"}),V("span",{id:"minutes",children:[" ",r," "]})]}),V("div",{className:"resultWrapper",children:[S("label",{htmlFor:"seconds",children:"Seconds"}),V("span",{id:"seconds",children:[" ",o," "]})]})]})]})]})}function mg(){return S(O1,{children:V($1,{children:[S(Di,{path:"/ChronoSum/",element:S(H1,{})}),S(Di,{path:"/ChronoSum/SimpleSum",element:S(rg,{})}),S(Di,{path:"/ChronoSum/DurationSum",element:S(pg,{})})]})})}const hg=xe.button`
    background: none;
    border: none;
