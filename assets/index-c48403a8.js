...
`,Im=u.createContext({});function rw({children:e}){const[t,n]=u.useState(["Hours","Minutes","Minutes","Seconds","Miliseconds"]),[r,i]=u.useState(!1),[s,o]=u.useState([]);return b(Im.Provider,{value:{enabledFields:t,setEnabledFields:n,format:r,setFormat:i,events:s,setEvents:o},children:e})}function Cr(){return u.useContext(Im)}function ls({name:e,state:t,onChange:n}){const{enabledFields:r}=Cr();return ee(nw,{children:[b("label",{htmlFor:"name",children:e}),b("input",{type:"text",id:e,value:r.includes(e+"s")?t:"--",disabled:!r.includes(e+"s"),onChange:n}),b("span",{id:"Initial"+e+"Warning",className:"Warning"})]})}const iw=be.div`
    display: flex;
    flex-direction: column;
